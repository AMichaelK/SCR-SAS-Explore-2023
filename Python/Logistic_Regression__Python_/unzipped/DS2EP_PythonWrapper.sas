data sasep.out;
   ...
   in_out varchar(100) "EM_CLASSIFICATION");
      ...
      if null(pm) then do;
         pm = _new_ pymas();
         resultCode = pm.useModule('model_exec_0fe3409a-495a-4d9b-9851-71538094d568', 1);
         if resultCode then do;
            ...
            revision = pm.publish(pm.getSource(), 'model_exec_0fe3409a-495a-4d9b-9851-71538094d568');
