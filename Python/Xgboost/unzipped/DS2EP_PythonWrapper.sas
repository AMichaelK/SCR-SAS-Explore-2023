data sasep.out;
   ...
   in_out double "EM_EVENTPROBABILITY");
      ...
      if null(pm) then do;
         pm = _new_ pymas();
         resultCode = pm.useModule('model_exec_38e34995-be6f-44e1-94b0-abd594d43c5a', 1);
         if resultCode then do;
            ...
            revision = pm.publish(pm.getSource(), 'model_exec_38e34995-be6f-44e1-94b0-abd594d43c5a');
