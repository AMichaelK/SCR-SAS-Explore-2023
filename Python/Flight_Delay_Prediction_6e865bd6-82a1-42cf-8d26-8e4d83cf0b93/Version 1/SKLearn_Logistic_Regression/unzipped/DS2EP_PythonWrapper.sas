data sasep.out;
   ...
   in_out double "EM_EVENTPROBABILITY");
      ...
      if null(pm) then do;
         pm = _new_ pymas();
         resultCode = pm.useModule('model_exec_b6dd032e-ea6d-4334-9e1f-3d2db5352fd3', 1);
         if resultCode then do;
            ...
            revision = pm.publish(pm.getSource(), 'model_exec_b6dd032e-ea6d-4334-9e1f-3d2db5352fd3');
