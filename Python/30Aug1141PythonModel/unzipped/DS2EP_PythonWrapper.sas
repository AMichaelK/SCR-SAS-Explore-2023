data sasep.out;
   ...
   in_out varchar(100) "EM_CLASSIFICATION");
      ...
      if null(pm) then do;
         pm = _new_ pymas();
         resultCode = pm.useModule('model_exec_66f8f1b0-4de6-474e-89a4-cbbbe48df45e', 1);
         if resultCode then do;
            ...
            revision = pm.publish(pm.getSource(), 'model_exec_66f8f1b0-4de6-474e-89a4-cbbbe48df45e');
