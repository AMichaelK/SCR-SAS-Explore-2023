data sasep.out;
   ...
   in_out double "EM_EVENTPROBABILITY");
      ...
      if null(pm) then do;
         pm = _new_ pymas();
         resultCode = pm.useModule('model_exec_65c071e3-7870-41c7-a04f-84b9a06bae20', 1);
         if resultCode then do;
            ...
            revision = pm.publish(pm.getSource(), 'model_exec_65c071e3-7870-41c7-a04f-84b9a06bae20');
