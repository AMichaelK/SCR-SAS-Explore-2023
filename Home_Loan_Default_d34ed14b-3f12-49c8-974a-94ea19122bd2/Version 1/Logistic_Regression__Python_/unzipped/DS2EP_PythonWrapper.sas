data sasep.out;
   ...
   in_out varchar(100) "EM_CLASSIFICATION");
      ...
      if null(pm) then do;
         pm = _new_ pymas();
         resultCode = pm.useModule('model_exec_07938c09-da46-49f3-9f42-735f48f31f16', 1);
         if resultCode then do;
            ...
            revision = pm.publish(pm.getSource(), 'model_exec_07938c09-da46-49f3-9f42-735f48f31f16');
