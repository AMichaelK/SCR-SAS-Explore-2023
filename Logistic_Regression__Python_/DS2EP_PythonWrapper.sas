data sasep.out;
   ...
   in_out varchar(100) "EM_CLASSIFICATION");
      ...
      if null(pm) then do;
         pm = _new_ pymas();
         resultCode = pm.useModule('model_exec_49bc6629-b64f-46ae-ba9e-ea1cb08d2cc9', 1);
         if resultCode then do;
            ...
            revision = pm.publish(pm.getSource(), 'model_exec_49bc6629-b64f-46ae-ba9e-ea1cb08d2cc9');
