data sasep.out;
   ...
   in_out double "EM_EVENTPROBABILITY");
      ...
      if null(pm) then do;
         pm = _new_ pymas();
         resultCode = pm.useModule('model_exec_485e82c6-dd62-49e8-a578-92700a3b5bcc', 1);
         if resultCode then do;
            ...
            revision = pm.publish(pm.getSource(), 'model_exec_485e82c6-dd62-49e8-a578-92700a3b5bcc');
